...
const Calculator = ({ btnUrl, btnLabel }) => {
  ...
  return (
    <div className="md:grid md:grid-cols-2">
      ...
      <div
        data-aos="fade-right"
        className="md:order-2 h-fit pb-16 text-center  md:text-left px-4 md:pl-8 "
      >
        <div>
      ...
      <div
        data-aos="fade-right"
        className="bg-gray-700 h-fit text-center md:text-left pl-4 pr-4 md:pl-4  pt-8 pb-16"
      >
        ...
        <div>
          <form className="grid md:pr-2 md:gap-4 md:grid-cols-2">
            {/* Purchase Price    */}
            <div>
              <span className="text-xl md:text-xs  font-bold text-white">
                Purchase Price: ${purchase.toLocaleString('en-US')}
              </span>
              <input
                className={`${styles.slider} w-full h-4 mb-4 `}
                type="range"
                min={payment}
                max="1000000"
                value={purchase}
            ...
            <div>
              <span className="text-xl md:text-xs  font-bold text-white">
                Down Payment: ${payment.toLocaleString('en-US')}
              </span>
              <input
                className={`${styles.slider} w-full h-4 mb-4`}
                type="range"
