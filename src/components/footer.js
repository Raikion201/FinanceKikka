...
const data = [
  {
    cate: 'Location',
    info: ['America', 'Asia', 'Europe', 'Africa'],
  },
  {
    cate: 'Contact',
    info: ['About me', 'Teams', 'Profile', 'FAQ'],
  },
  {
    cate: 'Legals',
    info: ['Privacy', 'Disclaimer', 'Terms', 'Company'],
  },
]

const Footer = () => (
  <div className="mt-16 md:grid md:grid-cols-2">
            ...
            <div className="flex justify-center flex-col text-center md:text-left">
              ...
              <ul>
                {content.info.map((info) => (
                  <li
                    className={`${styles.info} text-gray-500 cursor-pointer my-4 font-normal text-sm`}
                  >
                    {info}
                  </li>
                ))}
    ...
    <div>
      <div className="grid grid-cols-2 md:grid-cols-none md:grid-rows-2 my-4 md:px-16 lg:px-44">
        <div className="ml-4 md:ml-0  flex items-center ">
          <Logo />
          <div className="pl-2  text-black font-bold text-sm md:text-lg inline-block">
            Kinka
            <br />
            Finance
          </div>
      ...
      <div className="flex justify-center h-20 ">
        <div className="inline-flex space-x-4">
          <div
            className={`${styles.icon} text-white w-8 h-8 flex items-center justify-center rounded-full cursor-pointer`}
          >
